...
class C1Controller extends Controller
{
    ...
    {
        $product = Product::where('kind_id','=','1')
            ->paginate(6);
...
//C1 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','1-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-5')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-6')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-7')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','1-8')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C1 商品內容
    ...
    {
        $product = Product::where('kind_id','=','2')
            ->paginate(6);
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C2 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','2-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-5')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-6')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-7')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','2-8')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C2 商品內容
    ...
    {
        $product = Product::where('kind_id','=','3')
            ->paginate(6);
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C3 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','3-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-5')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-6')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-7')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-8')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','3-9')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C3 商品內容
    ...
    {
        $product = Product::where('kind_id','=','4')
            ->paginate(6);
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C4 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','4-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','4-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','4-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','4-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C4 商品內容
    ...
    {
        $product = Product::where('kind_id','=','5')
            ->paginate(6);
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C5 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','5-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-5')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-6')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-7')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-8')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','5-9')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C5 商品內容
    ...
    {
        $product = Product::where('kind_id','=','6')
            ->paginate(6);
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
...
//C6 商品內容
    ...
    {
        $product = Product::where('id_sequence','=','6-1')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-2')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-3')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-4')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-5')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-6')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-7')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-8')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
    ...
    {
        $product = Product::where('id_sequence','=','6-9')
            ->get();
        $result = ['products'=>$product];
        if (Auth::check()) {
            $name = Order::where('user_id', '=', Auth::user()->id)
