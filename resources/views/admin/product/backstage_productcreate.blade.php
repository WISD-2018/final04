            ...
            <div class="col-lg-12">
              <form action="/BackstageProduct" method="POST" role="form">
                ...
                <div class="form-group">
                  <label>名稱：</label>
                  <input type="string" class="form-control" name="name" placeholder="請輸入商品名稱">
                </div>

                <div class="form-group">
                  <label>圖示：</label>
                  <input type="string" class="form-control" name="picture" placeholder="請輸入商品圖示連結">
                </div>

                <div class="form-group">
                  <label>時間：</label>
                  <input type="string" class="form-control" name="time" placeholder="請輸入商品拆解時間">
                </div>

                <div class="form-group">
                  <label>來源：</label>
                  <input type="string" class="form-control" name="where" placeholder="請輸入商品來源">
                </div>

                <div class="form-group">
                  <label>型號：</label>
                  <input type="string" class="form-control" name="source" placeholder="請輸入商品型號">
                </div>

                <div class="form-group">
                  <label>價格：</label>
                  <input type="string" class="form-control" name="price" placeholder="請輸入商品價格">
                </div>

                <div class="form-group">
                  <label>類別：</label>
                  <input type="string" class="form-control" name="kind" placeholder="請輸入商品類別">
                </div>

                <div class="form-group">
                  <label>庫存：</label>
                  <input type="string" class="form-control" name="stock" placeholder="請輸入商品庫存">
                </div>
